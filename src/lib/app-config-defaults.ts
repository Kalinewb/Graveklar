...
export const APP_CONFIG_DEFAULTS: AppConfigItem[] = [
  ...
  { key: 'pricingIncludedNote', value: '**Hva er inkludert?** **Drivstoff for hele leieperioden**, levering og henting inntil {{deliveryIncludedKm}} km, forsikring, vask og opplæring. Ekstra timer: {{preOrderHourRate}} kr/t.', label: 'Notat under prisene', group: 'content', type: 'textarea', isPublic: true, sortOrder: 6, hint: 'Bruk {{deliveryIncludedKm}}, {{preOrderHourRate}} osv. for tall som følger innstillingene. **tekst** blir uthevet.' },
  { key: 'deliveryNote',        value: '**Prøv det!** Skriv inn adressen din i booking-skjemaet for å se nøyaktig leveringspris. Levering og henting er inkludert de første {{deliveryIncludedKm}} km.', label: 'Notat under leveringsprisen', group: 'content', type: 'textarea', isPublic: true, sortOrder: 7, hint: 'Samme tokens som notatet under prisene.' },
